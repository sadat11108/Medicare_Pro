...
try {
    ...
    if (!$doctor) {
        header("Location: Doctor&AppointmentManagement.php?error=Doctor not found");
        exit();
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $sql = "UPDATE doctors SET name = ?, specialty = ?, contact = ? WHERE id = ?";
        $stmt = $pdo->prepare($sql);
        $stmt->execute([$name, $specialty, $contact, $id]);
        
        header("Location: Doctor&AppointmentManagement.php?success=Doctor updated successfully!");
        exit();
    } catch(PDOException $e) {
        $error = $e->getMessage();
    }
...
<head>
    ...
    <title>Edit Doctor - SmartHealth</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <a href="Doctor&AppointmentManagement.php" class="btn btn-secondary">
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <a href="Doctor&AppointmentManagement.php" class="btn btn-secondary">Cancel</a>
                        </form>
                    </div>
                </div>
            </main>
