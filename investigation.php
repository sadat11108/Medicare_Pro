...
<head>
    ...
    <title>Investigation Management - SmartHealth</title>
        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="investigation.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Investigation (Lab Tests) Management</h1>
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addInvestigationModal">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($row['result'] ?? 'Pending') ?></td>
                                        <td><?= date('M d, Y', strtotime($row['test_date'])) ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <?php if($row['status'] == 'Pending'): ?>
                                                <a href="update_investigation.php?id=<?= $row['id'] ?>&status=Completed" class="btn btn-sm btn-success">Complete</a>
                                            <?php endif; ?>
                                            <a href="view_investigation.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-info">View</a>
                                            <a href="edit_investigation.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">Edit</a>
                                            <a href="delete_investigation.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this test?')">Delete</a>
                                        </td>
                                    </tr>
                                    <?php endwhile; ?>
                                </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">New Lab Test</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <form action="add_investigation.php" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="test_type" class="form-control" placeholder="e.g., Blood Test, X-Ray, MRI" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Result</label>
                            <textarea name="result" class="form-control" rows="3" placeholder="Enter test results..."></textarea>
                        </div>
                    </div>
