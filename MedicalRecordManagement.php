...
<head>
    ...
    <title>Medical Records - SmartHealth</title>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $stmt = $pdo->query("SELECT mr.*, p.name as patient_name FROM medical_records mr JOIN patients p ON mr.patient_id = p.id ORDER BY mr.record_date DESC");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="view_record.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-info">View</a>
                                            <a href="edit_record.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">Edit</a>
                                            <a href="delete_record.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this record?')">Delete</a>
                                        </td>
                                    </tr>
                                    <?php endwhile; ?>
                                </tbody>
