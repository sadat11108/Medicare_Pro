...
// Fetch investigation with patient details
try {
    ...
    if (!$investigation) {
        header("Location: investigation.php?error=Test not found");
        exit();
    }
...
<head>
    ...
    <title>View Lab Test - SmartHealth</title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Lab Test Details</h1>
                    <div>
                        <a href="edit_investigation.php?id=<?= $investigation['id'] ?>" class="btn btn-warning">
                            <i class="bi bi-pencil"></i> Edit
                        </a>
                        <a href="investigation.php" class="btn btn-secondary">
                            ...
                            <div class="card-body">
                                <table class="table table-borderless">
                                    <tr>
                                        ...
                                        <td><strong><?= htmlspecialchars($investigation['patient_name']) ?></strong></td>
                                    </tr>
                                    <tr>
                                        <th>Age:</th>
                                        <td><?= $investigation['age'] ?> years</td>
                                    </tr>
                                    <tr>
                                        <th>Gender:</th>
                                        <td><?= $investigation['gender'] ?></td>
                                    </tr>
                                    <tr>
                                        <th>Contact:</th>
                                        <td><?= htmlspecialchars($investigation['contact']) ?></td>
                                    </tr>
                                    <tr>
                                        <th>Test Date:</th>
                                        <td><?= date('F d, Y', strtotime($investigation['test_date'])) ?></td>
                                    </tr>
                                    <tr>
                                        <th>Status:</th>
                                        <td>
                                            <span class="badge bg-<?= $investigation['status'] == 'Pending' ? 'warning' : 'success' ?> fs-6">
                    ...
                    <div class="col-md-7">
                        <div class="card shadow-sm mb-4">
                            <div class="card-header bg-success text-white">
                                <h5 class="mb-0"><i class="bi bi-microscope"></i> Test Details</h5>
                            </div>
                            <div class="card-body">
                                <div class="test-box">
                                    <h5 class="text-primary">Test Type</h5>
                                    <p class="fs-4 fw-bold"><?= htmlspecialchars($investigation['test_type']) ?></p>
                                    
                                    <h5 class="text-primary mt-3">Result</h5>
                                    <div class="border p-3 rounded bg-white">
                                        <?php if($investigation['result']): ?>
                                            <?= nl2br(htmlspecialchars($investigation['result'])) ?>
                                        <?php else: ?>
                                            <span class="text-muted">No results yet. Test is pending.</span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
