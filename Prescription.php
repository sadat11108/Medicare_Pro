...
<head>
    ...
    <title>Prescription Management - SmartHealth</title>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $stmt = $pdo->query("SELECT p.*, pt.name as patient_name 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="view_prescription.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-info">View</a>
                                            <a href="edit_prescription.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">Edit</a>
                                            <a href="delete_prescription.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Delete this prescription?')">Delete</a>
                                        </td>
                                    </tr>
                                    <?php endwhile; ?>
                                </tbody>
                ...
                <form action="add_prescription.php" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="instructions" class="form-control" rows="3" placeholder="Take twice daily for 7 days"></textarea>
                        </div>
                    </div>
